...
export const Route = createFileRoute("/departments/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cardiology, General Medicine, Gynaecology, Dentistry, Diagnostics, ICU and 24×7 Emergency at Aramana Hospital, Ashwini Nagar, Kasaragod." },
    ],
  }),
});
                ...
                <div className="p-10 flex-grow flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {d.services.slice(0, 3).map((s) => (
                      <span key={s} className="px-3 py-1 bg-soft-grey text-muted text-[10px] font-bold uppercase tracking-wider rounded-sm">
                        {s}
                      </span>
                    ))}
                  </div>
