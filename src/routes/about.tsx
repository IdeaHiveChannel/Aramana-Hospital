    ...
    <div className="bg-white">
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-8 text-muted text-lg leading-relaxed">
                <p>
                  ...
                  sits at the heart of our operations, with the Cath Lab and Cardiac ICU functioning
                  as a seamless clinical workflow.
                </p>
                <p>
                  For over two decades, we have served the Kasaragod district and surrounding
                  regions of North Kerala and South Coastal Karnataka. Our multi-specialty approach
                  ensures that while heart care is our core, we provide comprehensive clinical
                  support across all major disciplines.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-10 rounded-xl shadow-4xl border border-slate-100 hidden xl:block">
                ...
                <div className="grid grid-cols-2 gap-12">
                  ...
                  <div className="text-center">
                    <div className="text-4xl font-black text-cardiac-blue leading-none mb-2">
                      10k+
                    </div>
      ...
      <section className="bg-soft-grey section-padding">
        <div className="container-custom text-center mb-12">
          <h2 className="text-cardiac-blue text-3xl md:text-4xl font-extrabold mb-4">
            Our Institutional Philosophy
          </h2>
          <p className="text-muted text-base max-w-2xl mx-auto">
            Founded on three pillars of healthcare excellence.
          </p>
        </div>
        ...
        <div className="container-custom grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            return (
              <div
                key={idx}
                className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl transition-all"
              >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-16">
            <div className="max-w-3xl">
              ...
              <h2 className="text-cardiac-blue text-3xl md:text-5xl font-extrabold tracking-tighter leading-tight">
                Life at{" "}
                <span className="text-emerald italic font-serif font-normal">Aramana Hospital</span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="text-white/60 text-lg md:text-xl leading-relaxed italic font-serif mb-10">
                ...
                with access to the same level of cardiac and multi-specialty care they would find in
                major metros, but with the empathy and personal touch of a community hospital."
              </div>
              <div>
                <div className="text-white font-bold text-xl">Aramana Management</div>
                <div className="text-emerald text-[10px] uppercase tracking-widest font-bold">
                  Kasaragod, Kerala
                </div>
              </div>
            </div>
