      ...
      <div className="container-custom relative z-10 pt-20 pb-32">
        ...
        >
          ...
          <p className="text-white/70 text-lg md:text-xl max-w-3xl leading-relaxed mb-16 font-medium">
            Aramana Hospital provides immediate life-saving cardiac and general emergency reception.
            Our specialized response teams are available 24/7 at Ashwini Nagar, Kasaragod.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            ...
            >
              ...
              <div>
                <div className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/60 mb-2">
                  Emergency & Ambulance
                </div>
                <div className="text-3xl font-extrabold tracking-tighter">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 pt-20 border-t border-white/10">
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-white font-extrabold mb-3 uppercase tracking-[0.2em] text-[10px] md:text-[11px]">
                  Location
                </h4>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-white/50 text-sm leading-relaxed font-medium">
                  Cardiac intervention, Trauma stabilization, 24/7 ICU support.
                </p>
              </div>
            </div>
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-white/50 text-sm leading-relaxed font-medium">
                  Open 24 hours, 365 days a year. Cardiac teams on call.
                </p>
              </div>
            </div>
          </div>
