          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            <div className="lg:col-span-7">
              ...
              <h2 className="heading-section text-cardiac-blue">
                ...
                <span className="text-emerald text-display font-normal">{dept.name}</span>.
              </h2>
              <div className="space-y-8 text-editorial mb-16">
                {dept.body.map((p: string, i: number) => (
                  <p key={i}>{p}</p>
                ))}
              </div>
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="bg-diagnostic-navy p-10 rounded-xl text-white shadow-3xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-xl font-extrabold mb-8 uppercase tracking-widest text-white/60 text-[11px]">
                      Direct Assistance
                    </h3>
                    <div className="space-y-8">
                      ...
                      <Link
                        to="/appointment"
                        className="w-full btn-emerald flex items-center justify-center gap-4 py-5 shadow-2xl"
                      >
                        <Calendar size={18} />
                ...
                <div className="bg-slate-50 p-10 rounded-xl border border-slate-100">
                  <h3 className="text-muted font-extrabold text-[11px] uppercase tracking-[0.2em] mb-8">
                    Patient Information
                  </h3>
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={idx}
                        className="flex items-center gap-4 text-cardiac-blue font-bold text-[11px] uppercase tracking-widest"
                      >
        ...
        <section className="bg-slate-50 section-padding">
          <div className="container-custom">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
              ...
              <Link
                to="/doctors"
                className="inline-flex items-center gap-4 text-cardiac-blue font-bold uppercase tracking-[0.2em] text-[11px] group transition-all pb-4"
              >
                <span className="group-hover:text-emerald transition-colors">All Doctors</span>
                <ArrowRight
                  size={18}
                  className="text-emerald transition-transform group-hover:translate-x-2"
                />
              </Link>
            </div>
                ...
                >
                  <div className="p-10 grow flex flex-col">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <span className="text-emerald font-bold uppercase tracking-widest text-[9px]">
