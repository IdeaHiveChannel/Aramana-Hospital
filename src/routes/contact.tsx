          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-5 space-y-12">
              ...
              >
                ...
                <h3 className="text-2xl font-extrabold text-cardiac-blue mb-4 uppercase tracking-tight">
                  Visit our Facility
                </h3>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      <div className="text-[10px] uppercase font-bold text-muted tracking-widest mb-0.5">
                        Reception 24/7
                      </div>
                      <div className="text-xl font-bold text-cardiac-blue">
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
              <h4 className="text-cardiac-blue text-xl font-extrabold mb-4 uppercase tracking-tight">
                Regional Accessibility
              </h4>
              <p className="text-muted text-sm leading-relaxed font-medium">
                Serving patients across North Kerala and South Karnataka. We provide coordination
                and ambulance services for
                <span className="text-cardiac-blue font-bold">
                  {" "}
                  Kasaragod, Kanhangad, Uppala, Manjeshwar, Bekal
                </span>
                , and surrounding catchment zones.
              </p>
            </div>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <div className="text-3xl font-black text-cardiac-blue">24/7</div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-muted mt-1">
                  Response
                </div>
              </div>
