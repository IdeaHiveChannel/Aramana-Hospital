          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-12 max-w-2xl font-medium">
                Dr. Mansoor leads our interventional cardiology unit, specializing in emergency
                angioplasty and pacemaker procedures. With over 20 years of experience, he provides
                dedicated heart care for patients across Kasaragod and North Kerala.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                {expertise.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-4 text-white/80 text-[13px] uppercase tracking-wide font-bold"
                  >
              ...
              <div className="flex flex-wrap gap-6">
                <Link to="/cardiology" className="btn-emerald flex items-center gap-4">
                  <span>Cardiology Services</span>
                  <ArrowRight size={18} />
                </Link>

                <Link to="/appointment" className="btn-outline-white flex items-center gap-4">
