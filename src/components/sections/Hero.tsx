        ...
        <div className="container-custom relative z-20 grow flex flex-col justify-center pt-[140px] pb-[80px] md:pt-[160px] md:pb-[100px] lg:pt-[120px] lg:pb-[80px]">
          ...
          >
            <div className="flex flex-col">
              <span className="text-emerald font-bold uppercase tracking-[0.4em] text-[10px] md:text-[11px] mb-6 md:mb-8 font-brand">
                Institutional Cardiac Excellence
              </span>
            ...
            <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-10 md:mb-16 font-medium">
              ...
              North Kerala's heart center with dedicated ICU monitoring and experienced clinical
              consultants.
            </p>

            <div className="flex flex-wrap gap-6">
              <Link to="/appointment" className="btn-emerald flex items-center gap-3">
                <Calendar size={18} />
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <ChevronDown
                  size={18}
                  className={`text-emerald transition-transform ${activeDropdown === "dept" ? "rotate-180" : "group-hover:translate-y-1"}`}
                />
              </div>
                  ...
                  >
                    ...
                    <div className="max-h-64 overflow-y-auto py-2">
                      {departments.map((dept) => (
                        ...
                        >
                          <span className="text-sm font-bold uppercase tracking-tight group-hover/item:text-emerald">
                            {dept.name}
                          </span>
                          <ArrowRight
                            size={14}
                            className="opacity-0 -translate-x-2 group-hover/item:opacity-100 group-hover/item:translate-x-0 transition-all text-emerald"
                          />
                        </Link>
                      ))}
                    </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <ChevronDown
                  size={18}
                  className={`text-emerald transition-transform ${activeDropdown === "doc" ? "rotate-180" : "group-hover:translate-y-1"}`}
                />
              </div>
                    ...
                    <div className="max-h-80 overflow-y-auto py-2">
                      {doctors.map((doc) => (
                        ...
                        >
                          ...
                          <span className="text-[9px] uppercase tracking-wider text-muted mt-1 font-medium">
                            {doc.title}
                          </span>
                        </Link>
                      ))}
