        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-cardiac-blue text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.1] mb-10">
              25+ Years of <br />
              <span className="text-emerald text-3xl md:text-4xl lg:text-5xl font-normal italic font-serif">
                Advanced Healthcare
              </span>{" "}
              <br />
              in Kasaragod.
            ...
            <div className="space-y-6 text-editorial mb-12 max-w-xl">
              <p>
                Aramana Hospital & Heart Centre stands as a beacon of advanced interventional
                cardiology and multi-specialty medical care in North Kerala. For over two decades,
                we have provided thousands of patients from Kasaragod, Kanhangad, and nearby regions
                with precision diagnosis and empathy.
              </p>
              <p>
                Our infrastructure is built around a singular goal: providing immediate,
                high-quality cardiac intervention, including angioplasty and pacemaker procedures,
                when every second counts. With a state-of-the-art Cath Lab and 24/7 ICU monitoring,
                we are the trusted heart specialist hospital in Kasaragod.
              </p>
            </div>
            ...
            <div>
              ...
              >
                <span className="group-hover:text-emerald transition-colors border-b border-transparent group-hover:border-emerald pb-1">
                  Explore our Journey
                </span>
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-white/20 transform transition-transform group-hover:-translate-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[9px] uppercase tracking-[0.2em] font-bold text-muted mt-1">
                        Years of Trust
                      </span>
                    </div>
