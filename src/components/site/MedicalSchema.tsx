...
export function MedicalSchema() {
  const hospitalSchema = {
    ...
    description:
      "Advanced Cardiology & Multi-Specialty Hospital in Kasaragod, providing 24/7 emergency cardiac care, angioplasty, ICU, and diagnostics.",
    address: {
      "@type": "PostalAddress",
